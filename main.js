...
function updateCanvas(){
    ...
    document.getElementById("Draw").innerHTML = "Sketch to be drawn "+ quick_draw_data_set[random_number];
}
...
function classifyCanvas(){
    ...
    document.getElementById('show_sketch').innerHTML = 'What to draw' + quick_draw_data_set[random_number];
    }
